...
public class Test {
    public static void main(String[] args) {
        ...
        Shape shapeCircle = shapeFactory.getShape("CircleShape");
        Shape shapeRectangle = shapeFactory.getShape("RectangleShape");
        Shape shapeSqure = shapeFactory.getShape("SquareShape");
