 ...
 *
 * 缺点：
 * 1、配备克隆方法需要对类的功能进行通盘考虑，这对于全新的类不是很难，但
...
public class ArcheTypalTest {
    public static void main(String[] args) {
        ...
        AShape shape = ShapeCache.getShape("1");
        AShape shape2 = ShapeCache.getShape("2");
        AShape shape3 = ShapeCache.getShape("3");

        System.out.println("load shape:"+shape.getType());
        shape.draw();
        System.out.println("load shape:"+shape2.getType());
        shape2.draw();
        System.out.println("load shape:"+shape3.getType());
        shape3.draw();
